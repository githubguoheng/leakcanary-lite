...
import static com.squareup.leakcanarylite.Preconditions.checkNotNull;
import static com.squareup.leakcanarylite.Retryable.Result.DONE;
import static com.squareup.leakcanarylite.Retryable.Result.RETRY;
...
//    this.heapdumpListener = checkNotNull(heapdumpListener, "heapdumpListener");
  ...
  public void setHeapdumpListener(HeapDump.Listener heapdumpListener) {
  ...
  Retryable.Result ensureGone(final KeyedWeakReference reference, final long watchStartNanoTime) {
    ...
    if (!gone(reference)) {
      ...
      if (heapdumpListener != null) {
        ...
        heapdumpListener.upload(heapDump);
      }
    }
    return DONE;
  }
