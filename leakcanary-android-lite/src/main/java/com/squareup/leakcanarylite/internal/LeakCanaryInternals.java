 ...
 */
package com.squareup.leakcanarylite.internal;
...
import com.squareup.leakcanarylite.CanaryLog;
import com.squareup.leakcanarylite.DefaultLeakDirectoryProvider;
import com.squareup.leakcanarylite.HeapDump;
import com.squareup.leakcanarylite.LeakDirectoryProvider;
import com.squareup.leakcanarylite.R;
import com.squareup.leakcanarylite.RefWatcher;
...
public final class LeakCanaryInternals {
  ...
  private static volatile HeapDump.Listener heapDumpListener;

//  private static final String NOTIFICATION_CHANNEL_ID = "leakcanarylite";
...
//  }
  ...
  public static void setHeapDumpListener(HeapDump.Listener heapDumpListener) {
    if (LeakCanaryInternals.heapDumpListener != null) {
      throw new IllegalStateException("Cannot set the HeapDump.Listener after it has already \"\n" +
              "          + \"been set.");
    }

    if (LeakCanaryInternals.installedRefWatcher == null) {
      throw new IllegalStateException("Cannot set the HeapDump.Listener before LeakCanary.install() called");
    }

    LeakCanaryInternals.heapDumpListener = heapDumpListener;
    LeakCanaryInternals.installedRefWatcher.setHeapdumpListener(heapDumpListener);
  }
