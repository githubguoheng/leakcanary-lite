...
import com.squareup.leakcanarylite.internal.LeakCanaryInternals;

public final class LeakCanaryLite {
  ...
  public static @NonNull RefWatcher install(@NonNull Application application) {
    return refWatcher(application).excludedRefs(AndroidExcludedRefs.createAppDefaults().build())
        .buildAndInstall();
  }
  ...
  private static @NonNull AndroidRefWatcherBuilder refWatcher(@NonNull Context context) {
  ...
  /**
   * Used to do something after the heapdump file is created, analyze or upload to the server eg.
   * @param dumpListener {@link HeapDump.Listener}
   *
   * @throws IllegalStateException if a {@link HeapDump.Listener} has already been set or been set before
   * LeakCannary.install called
   */
  public static void setHeadDumpListener(HeapDump.Listener dumpListener) {
    LeakCanaryInternals.setHeapDumpListener(dumpListener);
  }
