...
import static com.squareup.leakcanarylite.tests.Fragments.waitForFragmentDetached;
import static com.squareup.leakcanarylite.tests.Fragments.waitForFragmentViewDestroyed;
...
public class FragmentLeakTest {
  ...
  @Before public void setUp() {
    LeakCanaryLite.installedRefWatcher().clearWatchedReferences();
  }
